...
def test_optimize_short_route_no_stops():
    ...
    stations = [
        {"name": "S1", "address": "Addr 1", "city": "City 1", "state": "ST", "price": 3.0, "dist": 100.0, "latitude": 40.0, "longitude": -75.0},
    ]
...
def test_optimize_greedy_cheaper_stop():
    ...
    stations = [
        {"name": "S1", "address": "Addr 1", "city": "City 1", "state": "ST", "price": 3.5, "dist": 300.0, "latitude": 40.0, "longitude": -75.0},
        {"name": "S2", "address": "Addr 2", "city": "City 2", "state": "ST", "price": 3.0, "dist": 400.0, "latitude": 41.0, "longitude": -76.0},
        {"name": "S3", "address": "Addr 3", "city": "City 3", "state": "ST", "price": 3.2, "dist": 600.0, "latitude": 42.0, "longitude": -77.0},
    ]
    ...
    assert res["fuel_stops"][0]["gallons"] == 30.0  # (800 - 400)/10 - 10 remaining fuel = 30
...
def test_optimize_impossible_route():
    ...
    stations = [
        {"name": "S1", "address": "Addr 1", "city": "City 1", "state": "ST", "price": 3.0, "dist": 600.0, "latitude": 40.0, "longitude": -75.0},
    ]
...
def test_optimize_multiple_stops():
    ...
    stations = [
        {"name": "S1", "address": "Addr 1", "city": "City 1", "state": "ST", "price": 3.5, "dist": 300.0, "latitude": 40.0, "longitude": -75.0},
        {"name": "S2", "address": "Addr 2", "city": "City 2", "state": "ST", "price": 3.0, "dist": 400.0, "latitude": 41.0, "longitude": -76.0},
        {"name": "S3", "address": "Addr 3", "city": "City 3", "state": "ST", "price": 3.2, "dist": 800.0, "latitude": 42.0, "longitude": -77.0},
        {"name": "S4", "address": "Addr 4", "city": "City 4", "state": "ST", "price": 2.8, "dist": 900.0, "latitude": 43.0, "longitude": -78.0},
    ]
